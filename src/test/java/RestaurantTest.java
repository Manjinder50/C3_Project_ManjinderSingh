...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime mockedCurrentTime = LocalTime.parse("21:00:00");
        when(restaurantSpy.getCurrentTime()).thenReturn(mockedCurrentTime);
        boolean restaurantOpen = restaurantSpy.isRestaurantOpen();
